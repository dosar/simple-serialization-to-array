...
class SerializerSpec extends WordSpec with Matchers {
  ...
  "StringSerializer" should {
    "serialize/deserialize" in {
      ...
      val buf = ByteBuffer.wrap(new Array[Byte](Length[String].apply(str)))
      buf.write(str)
      buf.rewind()
  ...
  "HListSerializer" should {
    "serialize/deserialize" in {
      ...
      val buf = ByteBuffer.wrap(new Array[Byte](Length[T].apply(hlist)))
      buf.write(hlist)
      buf.rewind()
    ...
    "serialize/deserialize generic case class" in {
      ...
      val buf = ByteBuffer.wrap(new Array[Byte](Length[gen.Repr].apply(hlist)))
      buf.write(hlist)
      buf.rewind()
  ...
  "Case class serializer" should {
    "serialize/deserialize" in {
      ...
      val buf = ByteBuffer.wrap(new Array[Byte](Length[StringIntPair].apply(value)))
      buf.write(value)
      buf.rewind()
    ...
    "serialize/deserialize nested types" in {
      ...
      val buf = ByteBuffer.wrap(new Array[Byte](Length[FailingCase].apply(value)))
      buf.write(value)
      buf.rewind()
    ...
    "serialize/deserialize big case class" in {
      ...
      val buf = ByteBuffer.wrap(new Array[Byte](Length[Test].apply(value)))
      buf.write(value)
      buf.rewind()
